            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="space-y-0">
                                <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="order-item">
                                        <?php if(optional($item->product)->image_path): ?>
                                            <img src="<?php echo e(optional($item->product)->image_url); ?>" alt="<?php echo e(optional($item->product)->name ?? $item->product_name ?? 'Product'); ?>" class="order-item-image">
                                        <?php else: ?>
                                        ...
                                        <?php endif; ?>
                                        <div class="flex-1">
                                            <p class="order-text font-bold" style="font-size: 16px; font-weight: 700;"><?php echo e(optional($item->product)->name ?? $item->product_name ?? 'Product'); ?></p>
                                            <?php if($item->variant || $item->variant_name): ?>
                                                <p class="text-sm" style="color: #666666; margin-top: 4px;">🎨 <?php echo e(optional($item->variant)->name ?? $item->variant_name); ?></p>
                                            <?php endif; ?>
                        ...
                        <!-- Service Requests -->
                        <?php if(method_exists($order, 'serviceRequests') && $order->relationLoaded('serviceRequests') && $order->serviceRequests->count() > 0): ?>
                            <div class="order-card p-8">
