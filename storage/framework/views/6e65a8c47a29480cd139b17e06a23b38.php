...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['title' => config('app.name', 'CICT Dingle')]));
...
foreach (array_filter((['title' => config('app.name', 'CICT Dingle')]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
            ...
            <footer class="bg-gray-900 text-gray-200 py-16 border-t border-gray-800 mt-16">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-10">
                        ...
                        <div style="display: flex; align-items: flex-start; gap: 22px; flex: 1; min-width: 280px;" class="footer-logo-section">
                            <div class="flex-shrink-0"
                                ...
                                <div
                                    ...
                                    ?>
                                    <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e(config('app.name', 'CICT Dingle')); ?> logo"
                                        class="w-full h-full object-cover" style="display:block; border-radius:9999px;">
                                </div>
                            </div>
                            <div>
                                <h3 class="font-bold text-xl text-white" style="margin: 0;"><?php echo e(config('app.name', 'CICT Dingle')); ?></h3>
                    ...
                    <div class="pt-4 text-sm flex flex-col sm:flex-row items-center sm:items-center sm:justify-between gap-2 sm:gap-4"
                        ...
                        <p class="m-0">&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'CICT Dingle')); ?> · ISUFST Dingle Campus</p>
