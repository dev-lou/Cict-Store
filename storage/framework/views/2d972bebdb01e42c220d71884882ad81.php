...
<div x-data="{ 
    ...
    <style>
        ...
        /* Fixed positioning for navbar badges - prevents cut-off */
            ...
            <nav class="navbar-glass flex justify-between items-center px-6 py-4"
                ...
                <div class="hidden md:flex items-center gap-12">
                    ...
                    <a href="<?php echo e(route('shop.index')); ?>"
                        class="navbar-link <?php echo e(request()->routeIs('shop.*') ? 'active' : ''); ?>">
                        Shop
                    </a>
                    <a href="<?php echo e(route('services.index')); ?>"
                        class="navbar-link <?php echo e(request()->routeIs('services.*') ? 'active' : ''); ?>">
                        Services
                    </a>
                    <a href="<?php echo e(route('contact.index')); ?>"
                        class="navbar-link <?php echo e(request()->routeIs('contact.*') ? 'active' : ''); ?>">
                        Contact
                    </a>
                </div>
                        ...
                        <div x-data="{
                            ...
                            <button @click="open = !open" :aria-expanded="open" aria-controls="notifications-panel"
                                ...
                                <span x-cloak x-show="unreadCount > 0" x-text="unreadCount"
                                    class="absolute inline-flex items-center justify-center font-bold leading-none text-white rounded-full"
                                    style="background: linear-gradient(135deg, #8B0000 0%, #A00000 100%); min-width: 20px; height: 20px; padding: 0 6px; font-size: 11px; top: -4px; right: -4px; border: 2px solid white; box-shadow: 0 2px 8px rgba(139, 0, 0, 0.4); z-index: 10;"></span>
                            </button>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div x-data="{ menuOpen: false }" class="relative hidden md:flex">
                            <button @click="menuOpen = !menuOpen"
                                ...
                                <?php else: ?>
                                    <div class="w-9 h-9 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-md ring-1 ring-black/5 border-2 border-white"
                                ...
                                <svg class="w-4 h-4 text-gray-500 transition-transform duration-200"
                                    :class="{ 'rotate-180': menuOpen }" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div x-show="menuOpen" @click.outside="menuOpen = false"
                                ...
                                <div class="dropdown-header px-4 py-4 flex items-center gap-3"
                                    ...
                                    <?php else: ?>
                                        <div class="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold shadow-sm border-2 border-white"
                                ...
                                <?php if(auth()->user()->isAdmin()): ?>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>"
                                        class="dropdown-item block px-4 py-3 text-sm font-semibold text-black transition-colors flex items-center gap-3"
                                        style="border-bottom: 1px solid rgba(0, 0, 0, 0.05);">
                                ...
                                <form method="POST" action="<?php echo e(route('logout')); ?>" class="block"
                                    ...
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
                                        class="logout-btn w-full text-left px-4 py-3 text-sm font-bold transition-colors text-red-600 flex items-center gap-3">
                                        <span class="text-lg">🚪</span>
                                        <span>Logout</span>
                                    </button>
                                </form>
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition-opacity ease-linear duration-300"
        ...
        x-transition:leave-end="opacity-0" @click="closeMobileMenu()" class="mobile-overlay" style="display: none;">
    </div>
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-300 transform"
        ...
        <!-- Navigation Links -->
        <nav class="py-2">
            <a href="/" @click="closeMobileMenu()" class="mobile-nav-link <?php echo e(request()->is('/') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('shop.index')); ?>" @click="closeMobileMenu()"
            ...
            <a href="<?php echo e(route('services.index')); ?>" @click="closeMobileMenu()"
            ...
            <a href="<?php echo e(route('contact.index')); ?>" @click="closeMobileMenu()"
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <?php if(auth()->user()->isAdmin()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" @click="closeMobileMenu()" class="mobile-nav-link">
                        <svg class="mobile-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('profile.show')); ?>" @click="closeMobileMenu()" class="mobile-nav-link">
                    <svg class="mobile-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('account.orders')); ?>" @click="closeMobileMenu()" class="mobile-nav-link">
                    <svg class="mobile-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('cart.index')); ?>" @click="closeMobileMenu()" class="mobile-nav-link">
                    <svg class="mobile-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z">
                        </path>
            ...
            <?php else: ?>
                <div class="p-4 space-y-3">
                    <a href="<?php echo e(route('login')); ?>" @click="closeMobileMenu()"
                    ...
                    <a href="<?php echo e(route('register')); ?>" @click="closeMobileMenu()"
