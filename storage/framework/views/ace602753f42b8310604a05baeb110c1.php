    ...
    <div id="receipt-content">
        ...
        <div class="items-section">
            ...
            <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item">
                    <div class="item-name"><?php echo e(optional($item->product)->name ?? $item->product_name ?? 'Product'); ?></div>
                    <?php if($item->variant || $item->variant_name): ?>
                        <div class="item-variant">Variant: <?php echo e(optional($item->variant)->name ?? $item->variant_name); ?></div>
                    <?php endif; ?>
