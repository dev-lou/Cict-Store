...
<head>
    ...
    <title>Receipt #<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?></title>
...
<body>
    <div class="page">
        <div class="actions">
            <a href="<?php echo e(route('account.orders')); ?>" class="btn secondary">Back to orders</a>
        ...
        <div class="paper" id="receipt-content">
            <div class="header">
                <div>
                    <div class="brand"><?php echo e(config('app.name', 'CICT Dingle')); ?></div>
                    <div class="tagline">Official receipt • CICT Student Council Office</div>
                </div>
                <div style="text-align:right;">
                    <div class="value">Order #<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?></div>
                    <div class="value small"><?php echo e($order->created_at->format('M d, Y \a\t g:i A')); ?></div>
                </div>
            </div>

            <div class="title">Payment Receipt</div>
            <div class="subline">Status: <?php echo e(ucfirst($order->status)); ?></div>

            <div class="grid">
                <div class="panel">
                    <div class="label">Bill to</div>
                    <div class="value"><?php echo e($order->customer ? $order->customer->name : auth()->user()->name); ?></div>
                    <div class="value small"><?php echo e($order->customer ? $order->customer->email : auth()->user()->email); ?></div>
                </div>
                <div class="panel">
                ...
                <div class="panel">
                    ...
                    <div class="value"><?php echo e(strtoupper(substr(md5($order->id . $order->created_at), 0, 8))); ?></div>
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <div class="value" style="font-size:13px;"><?php echo e(optional($item->product)->name ?? $item->product_name ?? 'Product'); ?></div>
                                    <?php if($item->variant || $item->variant_name): ?>
                                        <div class="muted">Variant: <?php echo e(optional($item->variant)->name ?? $item->variant_name); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center"><?php echo e($item->quantity); ?></td>
                                <td class="text-right">₱<?php echo e(number_format($item->unit_price, 2)); ?></td>
                                <td class="text-right">₱<?php echo e(number_format($item->unit_price * $item->quantity, 2)); ?></td>
                            </tr>
            ...
            <div class="totals">
                <div class="total-row"><span class="muted">Subtotal</span><strong>₱<?php echo e(number_format($order->items->sum('total_price'), 2)); ?></strong></div>
                <?php if($order->discount > 0): ?>
                    <div class="total-row"><span class="muted">Discount</span><strong>-₱<?php echo e(number_format($order->discount, 2)); ?></strong></div>
                <?php endif; ?>
                <div class="total-row grand"><span class="muted">Total due</span><strong>₱<?php echo e(number_format($order->total, 2)); ?></strong></div>
            </div>

            <div class="barcode">Receipt timestamp <?php echo e(now()->format('M d, Y \a\t g:i A')); ?></div>
