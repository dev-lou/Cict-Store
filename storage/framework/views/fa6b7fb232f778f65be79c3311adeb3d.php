...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', $product->name . ' - ' . config('app.name', 'CICT Dingle')); ?>
            ...
            <div class="product-grid">
                ...
                <div class="product-details">
                    ...
                    <div class="product-header">
                        ...
                        <h1 class="product-name desktop-only"><?php echo e($product->name); ?></h1>
                        ...
                        <div class="product-price" id="display-price">
                            <?php if($product->variants->count() > 0): ?>
                                ₱<?php echo e(number_format($product->variants->first()->getFinalPrice(), 2)); ?>
            ...
            <div class="reviews-section">
                <div class="reviews-header">
                    <h2 class="reviews-title">
                        Customer Reviews
                        <span class="reviews-count"><?php echo e($product->reviews->count()); ?>

                            <?php echo e(Str::plural('review', $product->reviews->count())); ?></span>
                    </h2>
                        ...
                        <div class="reviews-summary">
                            <div class="average-rating">
                                ...
                                <div class="average-rating-stars">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <svg class="star-icon <?php echo e($i <= round($product->averageRating()) ? '' : 'empty'); ?>"
                                ...
                                <div class="review-header">
                                    ...
                                    <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                                        <div class="review-stars">
                                            <?php for($i = 1; $i <= 5; $i++): ?>
                                                <svg class="star-icon <?php echo e($i <= $review->rating ? '' : 'empty'); ?>"
                                                    viewBox="0 0 20 20" fill="currentColor">
                                                    <path
                                                        d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                </svg>
