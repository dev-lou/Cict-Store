...
<head>
    ...
    <title><?php echo e($title); ?> - <?php echo e(config('app.name', 'CICT Dingle')); ?> Admin</title>
    ...
    <!-- Styles -->
    <?php echo $__env->make('components.vite-assets', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</head>
