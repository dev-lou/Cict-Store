...
<?php $component->withAttributes([]); ?>
    ...
    <div class="page-shell p-6">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo e($stats['active_services']); ?></div>
            </div>
            <div class="stat-card">
                <div class="stat-label">Total Officers</div>
                <div class="stat-value"><?php echo e($stats['total_officers']); ?></div>
            </div>
            <div class="stat-card">
                <div class="stat-label">Active Officers</div>
                <div class="stat-value"><?php echo e($stats['active_officers']); ?></div>
            </div>
        </div>
        ...
        <div class="services-grid" id="servicesGrid">
            <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="service-card <?php echo e($service->is_active ? '' : 'inactive'); ?>" data-id="<?php echo e($service->id); ?>">
                    <div class="service-head">
                        <div class="flex items-center gap-3 flex-1 min-w-0">
                            <div class="service-icon"><?php echo e($service->icon ?? '🖨️'); ?></div>
                            <div class="flex-1 min-w-0">
                                <div class="service-title"><?php echo e($service->title); ?></div>
                                <div class="service-category"><?php echo e(strtoupper($service->category)); ?></div>
                            </div>
                        </div>
                        <div class="toggle <?php echo e($service->is_active ? 'active' : ''); ?>" onclick="toggleService(<?php echo e($service->id); ?>)"></div>
                    </div>
                    <div class="service-body">
                        <p class="service-description"><?php echo e(\Illuminate\Support\Str::limit($service->description, 140)); ?></p>
                        <div class="meta-row">
                            <?php $displayPrice = $service->price_bw ?? $service->price_color; ?>
                            <?php if($displayPrice): ?>
                                <span class="price-chip">₱<?php echo e(number_format($displayPrice, 2)); ?></span>
                            <?php endif; ?>
                            <?php if($service->price_label): ?>
                                <span class="meta-badge"><?php echo e($service->price_label); ?></span>
                            <?php endif; ?>
                            <?php if($service->options->count()): ?>
                                <span class="meta-badge"><?php echo e($service->options->count()); ?> options</span>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="actions">
                        <button class="btn-action" onclick="editService(<?php echo e($service->id); ?>)">Edit</button>
                        <button class="btn-action" onclick="manageOptions(<?php echo e($service->id); ?>)">Options</button>
                        <button class="btn-action danger" onclick="deleteService(<?php echo e($service->id); ?>)">Delete</button>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            <?php $__empty_1 = true; $__currentLoopData = $officers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $officer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="officer-card" data-id="<?php echo e($officer->id); ?>">
                    <div class="avatar"><?php echo e($officer->initials); ?></div>
                    <div class="flex-1 min-w-0">
                        <div style="color: var(--text-primary); font-weight: 600; font-size: 15px;"><?php echo e($officer->name); ?></div>
                        <div style="color: var(--text-secondary); font-size: 12px;"><?php echo e($officer->title ?? 'OFFICER'); ?></div>
                        <?php if($officer->messenger_url): ?>
                            <a href="<?php echo e($officer->messenger_url); ?>" target="_blank" style="color: var(--primary); font-size: 12px; text-decoration: none;">Messenger</a>
                        <?php endif; ?>
                    </div>
                    <div class="flex gap-2">
                        <button class="btn-action" onclick="editOfficer(<?php echo e($officer->id); ?>)">Edit</button>
                        <button class="btn-action danger" onclick="deleteOfficer(<?php echo e($officer->id); ?>)">Delete</button>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <form id="serviceForm" onsubmit="submitService(event)">
                ...
                <div class="modal-body">
                    ...
                    <div class="icon-grid mb-4">
                        <?php $__currentLoopData = ['🖨️','🎨','📄','📦','🧾','✂️','🖼️','📐','💡','⚙️','🧵','🛠️','🎁','📊','🧮','🪄']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emoji): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="icon-pick" data-icon="<?php echo e($emoji); ?>" onclick="pickIcon('<?php echo e($emoji); ?>')"><?php echo e($emoji); ?></div>
    ...
    <script>
        ...
        const categoryMeta = <?php echo json_encode($categories->keyBy('name'), 15, 512) ?>;
        const officersData = <?php echo json_encode($officers, 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel_igp\resources\views/admin/services/index.blade.php ENDPATH**/ ?>