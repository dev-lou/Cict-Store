                                ...
                                <div class="service-footer">
                                    <?php if($startingPrice): ?>
                                        <div>
                                            ...
                                            <div class="service-price">₱<?php echo e(number_format($startingPrice, 2)); ?> <span style="font-size: 0.85em; font-weight: 400; color: var(--text-secondary);"><?php echo e($priceLabel); ?></span></div>
                                        </div>
                                    <?php endif; ?>
