...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => 'Buy List Management','subtitle' => 'Click any cell to edit - Excel-like interface with auto-save']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Buy List Management','subtitle' => 'Click any cell to edit - Excel-like interface with auto-save']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
