...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => 'Edit User Profile','subtitle' => 'Manage user information and permissions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit User Profile','subtitle' => 'Manage user information and permissions']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    <div class="mb-6 p-4 rounded-xl flex items-center gap-6" style="background: rgba(15, 111, 221, 0.05); border: 1px solid rgba(15, 111, 221, 0.2);">
                        <div class="flex-shrink-0">
                            <?php if($user->profile_picture): ?>
                                <img id="profile-preview" src="<?php echo e(asset('storage/' . $user->profile_picture)); ?>?t=<?php echo e(time()); ?>" alt="Profile" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 3px solid #0f6fdd; box-shadow: 0 4px 12px rgba(15, 111, 221, 0.3);">
                            <?php else: ?>
                        ...
                        <div class="flex-grow">
                            <h4 class="font-bold text-lg mb-1" style="color: #ffffff;"><?php echo e($user->name); ?></h4>
                            <p class="text-sm" style="color: #b0bcc4;"><?php echo e($user->email); ?></p>
                            <p class="text-xs mt-1" style="color: #999;">User ID: <span class="font-bold" style="color: #b0bcc4;">#<?php echo e($user->id); ?></span></p>
                        </div>
                        <div class="flex-shrink-0">
