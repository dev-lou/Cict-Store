...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => 'Admin Settings','subtitle' => 'Manage application settings, system configuration, and preferences']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Admin Settings','subtitle' => 'Manage application settings, system configuration, and preferences']); ?>
            ...
            <div class="p-8">
                ...
                <div style="background: rgba(15, 111, 221, 0.1); border: 2px solid rgba(15, 111, 221, 0.3); border-radius: 12px; padding: 16px;">
                    ...
                    <div class="mt-3 pt-3" style="border-top: 1px solid rgba(15, 111, 221, 0.2);">
                        ...
                        <p class="text-xl font-bold" style="color: #ffffff;"><?php echo e(config('app.name', 'CICT Dingle')); ?></p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        ...
                        <div style="width: 120px; height: 120px; border-radius: 12px; border: 2px solid #444; overflow: hidden; display: flex; align-items: center; justify-content: center; background: #0f0707;">
                            <?php if($favicon && $favicon->value): ?>
                                <img src="<?php echo e(Storage::disk('supabase')->url($favicon->value)); ?>" alt="Site Favicon" id="faviconPreview" style="width: 64px; height: 64px; object-fit: contain;">
                            <?php else: ?>
