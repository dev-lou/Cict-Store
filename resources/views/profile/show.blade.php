            ...
            <main class="main-content">
                ...
                <div class="content-card">
                    ...
                    <div class="avatar-section">
                        @if(auth()->user()->profile_picture)
                            <img src="{{ asset('storage/' . auth()->user()->profile_picture) }}" alt="Profile Picture" class="avatar-image">
                        @else
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <div style="display: flex; gap: 8px; align-items: center;">
                                    <span class="info-value" id="name-display">{{ auth()->user()->name }}</span>
                            ...
                            <div class="info-item">
                                ...
                                <div style="display: flex; gap: 8px; align-items: center;">
                                    <span class="info-value" id="email-display">{{ auth()->user()->email }}</span>
                ...
                <div class="stats-section">
                    ...
                    <div class="stats-grid">
                        ...
                        <a href="{{ route('cart.index') }}" class="stat-card">
                            ...
                            @endphp
                            <div class="stat-value"><span class="cart-count-badge">{{ $cartCount }}</span></div>
                ...
                <div class="quick-actions-section">
                    ...
                    <div class="action-grid">
                        <a href="{{ route('shop.index') }}" class="action-btn">🛍️ Shop</a>
                        <a href="{{ route('account.orders') }}" class="action-btn">📋 Orders</a>
                        <a href="{{ route('cart.index') }}" class="action-btn">🛒 Cart</a>
                    </div>
                </div>
            </main>
        </div>
