<x-app-layout :title="'My Profile - ' . config('app.name', 'CICT Dingle')">
    <style>
        :root {
            --ink: #0f172a;
            --muted: #475569;
                    ...
                    <div class="meta-chip">Account type
                        @forelse($rolesArray as $role)
                            <span class="meta-chip"
                                style="background: rgba(139,0,0,0.12); color: var(--accent);">{{ ucfirst($role) }}</span>
                        @empty
                    ...
                    <div class="field-row" style="margin-top:6px;">
                        <div>
                            ...
                            <div class="field-value">
                                @forelse($rolesArray as $role)
                                    <span class="meta-chip"
                                        style="background: rgba(15,23,42,0.06); color:#0f172a;">{{ ucfirst($role) }}</span>
                                @empty
                                    <span class="meta-chip">Standard</span>
                                @endforelse
                            </div>
                        ...
                        <form method="POST" action="{{ route('profile.update-password') }}" class="form-grid">
                            ...
                            <div>
                                ...
                                @error('current_password')
                                    <span
                                        style="color: #ff0000; font-size: 12px; margin-top: 4px; display: block;">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
