...
<div x-data="{ 
            ...
            <nav class="navbar-glass flex justify-between items-center px-6 py-4"
                ...
                <div class="hidden md:flex items-center gap-12">
                    ...
                    <a href="{{ route('shop.index') }}"
                        class="navbar-link {{ request()->routeIs('shop.*') ? 'active' : '' }}">
                        Shop
                    </a>
                    <a href="{{ route('services.index') }}"
                        class="navbar-link {{ request()->routeIs('services.*') ? 'active' : '' }}">
                        Services
                    </a>
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-300 transform"
        ...
        <nav class="py-2">
            ...
            <a href="{{ route('shop.index') }}" @click="closeMobileMenu()"
            ...
            <a href="{{ route('services.index') }}" @click="closeMobileMenu()"
            ...
            <a href="{{ route('contact.index') }}" @click="closeMobileMenu()"
            ...
            @auth
                ...
                <a href="{{ route('profile.show') }}" @click="closeMobileMenu()" class="mobile-nav-link">
                    <svg class="mobile-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('account.orders') }}" @click="closeMobileMenu()" class="mobile-nav-link">
                    <svg class="mobile-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('cart.index') }}" @click="closeMobileMenu()" class="mobile-nav-link">
                    <svg class="mobile-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z">
                        </path>
            ...
            @else
                <div class="p-4 space-y-3">
                    <a href="{{ route('login') }}" @click="closeMobileMenu()"
                    ...
                    <a href="{{ route('register') }}" @click="closeMobileMenu()"
