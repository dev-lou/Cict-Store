<x-admin-layout>
    ...
    <div class="mb-8">
        ...
        <p class="mt-1" style="color: #94a3b8;">View and manage {{ strtolower($pageTitle) }}</p>
    </div>
    ...
    <div class="rounded-lg shadow-lg p-6 mb-6" style="background-color: #1e293b; border: 1px solid #334155;">
        <form method="GET" class="flex gap-4 flex-wrap items-end">
            ...
            <!-- Clear Filters -->
            <a href="{{ request()->url() }}" class="px-6 py-2 rounded-lg font-bold transition-colors text-center" style="background-color: transparent; color: #94a3b8; border: 1px solid #334155;" onmouseover="this.style.backgroundColor='#334155';" onmouseout="this.style.backgroundColor='transparent';">
                Clear
            </a>
        </form>
    </div>
