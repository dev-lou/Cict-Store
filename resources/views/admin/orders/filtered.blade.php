<x-admin-layout>
    ...
    <!-- Page Header -->
    <x-admin.page-header :title="$pageTitle" :subtitle="'View and manage ' . strtolower($pageTitle)">
        <x-slot:actions>
    ...
    <!-- Filter Bar -->
    <x-admin.filter-bar action="{{ request()->url() }}">
        <!-- Search Bar -->
        ...
        <x-admin.button href="{{ request()->url() }}" variant="secondary">
            Clear
        </x-admin.button>
    </x-admin.filter-bar>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <p class="text-lg font-semibold" style="color: rgba(255, 255, 255, 0.6);">No {{ strtolower($pageTitle) }} found</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
