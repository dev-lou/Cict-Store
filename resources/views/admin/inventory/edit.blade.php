                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <div style="display: flex; gap: 10px; align-items: center;">
                                    ...
                                    <select id="badgeColorPreset" class="form-input" style="flex: 1;"
                                        ...
                                        <option value="#8B0000" {{ ($product->badge_color ?? '#8B0000') == '#8B0000' ? 'selected' : '' }}>🔴 Maroon (Default)</option>
                                        <option value="#DC2626" {{ $product->badge_color == '#DC2626' ? 'selected' : '' }}>🔴 Red</option>
                                        <option value="#16A34A" {{ $product->badge_color == '#16A34A' ? 'selected' : '' }}>🟢 Green (Eco/New)</option>
                                        <option value="#2563EB" {{ $product->badge_color == '#2563EB' ? 'selected' : '' }}>🔵 Blue</option>
                                        <option value="#9333EA" {{ $product->badge_color == '#9333EA' ? 'selected' : '' }}>🟣 Purple</option>
                                        <option value="#F59E0B" {{ $product->badge_color == '#F59E0B' ? 'selected' : '' }}>🟡 Orange (Sale)</option>
                                        <option value="#EC4899" {{ $product->badge_color == '#EC4899' ? 'selected' : '' }}>💗 Pink (Valentine)</option>
                                        <option value="#059669" {{ $product->badge_color == '#059669' ? 'selected' : '' }}>🎄 Christmas Green</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div style="text-align: center;">
                                    ...
                                    <span
                                        style="color: #22c55e; font-weight: 700; font-size: 2rem;">₱{{ number_format($product->variants->avg('price_modifier') ?? 0, 2) }}</span>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr class="variant-row" data-variant-id="{{ $variant->id }}"
                                            ...
                                            <td style="padding: 14px 16px; text-align: center;">
                                                ...
                                                @if($variant->stock_quantity <= 20)
                                                    <span
                                                        style="display: block; color: #ff9500; font-size: 0.75rem; margin-top: 4px; font-weight: 600;">⚠️
                                                        Low Stock</span>
                                                @endif
                                            </td>
                                            <td style="padding: 14px 16px; text-align: center;">
                        ...
                        <div id="variantsFormSection"
                            ...
                            <div
                                ...
                                <h4
                                    ...
                                    <span>➕</span><span>Create Variants</span>
                                </h4>
                                <button type="button" id="closeVariantsBtn" class="btn-danger"
                                    style="padding: 8px 14px; font-size: 0.95rem;">✕ Close</button>
                            </div>
