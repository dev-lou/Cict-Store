<x-admin-layout>
    @section('page-title', 'Add Service Option')
    ...
    <div class="p-6" style="background: var(--bg-main); min-height: calc(100vh - 4rem);">
        <div class="mb-6">
            <h1 class="text-3xl font-bold" style="color: var(--text-primary);">Add Option for {{ $service->title }}</h1>
            <p class="text-sm mt-1" style="color: var(--text-secondary);">Create a new pricing option or variant</p>
        </div>

        <div class="form-card">
            <form action="{{ route('admin.services.options.store', $service) }}" method="POST">
                @csrf
                ...
                <div class="form-grid">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            value="{{ old('price_secondary_label') }}"
                            placeholder="e.g., per page"
                        >
                    ...
                    <div>
                        ...
                        <select 
                            ...
                            required
                        >
                            <option value="short" {{ old('size_class') === 'short' ? 'selected' : '' }}>Compact</option>
                            <option value="standard" {{ old('size_class', 'standard') === 'standard' ? 'selected' : '' }}>Standard</option>
                            <option value="long" {{ old('size_class') === 'long' ? 'selected' : '' }}>Large</option>
                        </select>
                        @error('size_class')
                            <p class="error-text">{{ $message }}</p>
                        @else
                ...
                <div class="flex gap-3" style="margin-top: 20px;">
                    ...
                    <a href="{{ route('admin.services.options.index', $service) }}" class="btn-secondary">
                        Cancel
                    </a>
                </div>
            </form>
