                                ...
                                <td class="text-right">
                                    <div class="inline-flex gap-2">
                                        ...
                                        <form id="delete-option-{{ $option->id }}"
                                            action="{{ route('admin.services.options.destroy', $option) }}" method="POST"
                                            class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                                                onclick="confirmDeleteOption({{ $option->id }}, '{{ $option->name }}')"
                                                class="btn-ghost btn-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20">
                                                Delete
                                            </button>
                                        </form>
                                    </div>
