<x-admin-layout>
    @section('page-title', 'Add Service Officer')
    ...
    <div class="p-6" style="background: var(--bg-main); min-height: calc(100vh - 4rem);">
        <div class="mb-6">
            <h1 class="text-3xl font-bold" style="color: var(--text-primary);">Add Service Officer</h1>
            <p class="text-sm mt-1" style="color: var(--text-secondary);">Create a new contact officer for student services</p>
        </div>

        <div class="form-card">
            <form action="{{ route('admin.service-officers.store') }}" method="POST">
                @csrf
