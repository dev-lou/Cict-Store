    ...
    <div class="checkout-shell">
        ...
        <form method="POST" action="{{ route('checkout.store') }}">
            ...
            <div class="checkout-grid">
                    ...
                    @foreach ($items as $item)
                        <div class="item">
                            ...
                            <div class="item-head">
                                ...
                                @endif
                                <p class="muted">Qty: {{ $item['quantity'] }} × ₱{{ number_format($item['price'], 2) }}</p>
                            </div>
                ...
                <aside>
                    <a href="{{ route('cart.index') }}" class="ghost-btn" style="margin-bottom:16px;">← Back to Cart</a>

                    <div class="card" style="position:sticky; top:120px;">
                        <h3 class="section-title">Order Total</h3>
                        <div class="summary-row"><span>Subtotal</span><span class="price">₱{{ number_format($subtotal, 2) }}</span></div>
                        <div class="summary-total"><span>Total</span><span class="price">₱{{ number_format($subtotal, 2) }}</span></div>
