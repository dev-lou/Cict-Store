                                    ...
                                    @foreach ($items as $item)
                                        <div class="order-item">
                                            ...
                                            @elseif ($item['product']->image_path)
                                                <img src="{{ Str::startsWith($item['product']->image_path, 'http') ? $item['product']->image_path : asset('storage/' . $item['product']->image_path) }}" alt="{{ $item['product']->name }}" class="order-item-image">
                                            @else
