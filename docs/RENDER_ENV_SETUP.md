...
| `APP_KEY` | `REDACTED_APP_KEY=` | Laravel encryption key |
...
| `AWS_SECRET_ACCESS_KEY` | `REDACTED_SUPABASE_SERVICE_ROLE_KEY` | Supabase service role key |
...
AWS_SECRET_ACCESS_KEY=REDACTED_SUPABASE_SERVICE_ROLE_KEY
