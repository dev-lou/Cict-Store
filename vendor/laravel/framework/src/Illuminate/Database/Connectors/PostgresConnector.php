...
class PostgresConnector extends Connector implements ConnectorInterface
{
    ...
    protected function getDsn(array $config)
    {
        ...
        // Support passing Neon endpoint id to the DSN so libpq receives the
        // endpoint SNI parameter. This is required for Neon when the PHP
        // libpq client doesn't add SNI automatically.
